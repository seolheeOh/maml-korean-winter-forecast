...
exp_name = 'kortemp_DJF/train-itr100-up10/'
exp_path = main_dir+'output/'+exp_name+'/'

opath = exp_path+'ENS01/'
...
train_inp_query, train_lab_query, train_inp_support, train_lab_support = \
        Dataload.get_train_dataset(train_inp, train_lab, 100, batch_size)
